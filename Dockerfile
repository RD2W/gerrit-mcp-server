...
RUN cargo build --release && \
    upx --best /build/target/release/gerrit-mcp
...
LABEL org.opencontainers.image.title="gerrit-mcp" \
      org.opencontainers.image.description="MCP server for Gerrit code review (AOSP-scale codebases)" \
      org.opencontainers.image.vendor="RD2W" \
      org.opencontainers.image.authors="Maxim Krutovercev (mkrutovercev@yandex.ru)" \
      org.opencontainers.image.documentation="https://github.com/RD2W/gerrit-mcp-server" \
      org.opencontainers.image.url="https://github.com/RD2W/gerrit-mcp-server" \
      org.opencontainers.image.source="https://github.com/RD2W/gerrit-mcp-server" \
