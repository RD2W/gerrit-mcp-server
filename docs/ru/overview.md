...
`gerrit-mcp` упаковывает всё это в 29 аккуратных MCP-инструментов с корректной
...
### 29 инструментов MCP — полное покрытие Gerrit REST API
...
**v1.1.1.** HTTP-клиент, все 29 инструментов MCP, двойной транспорт,
кэширование, ограничение частоты, TLS, health-эндпоинты и упаковка в Docker
реализованы и покрыты **216 тестами**. Поддержка MCP 2026-07-28 (stateless
