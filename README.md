...
- **32 MCP tools** — full Gerrit REST API coverage: query changes, manage
...
- [Usage](docs/en/usage.md) — config reference, transport modes, all 32 MCP tools
...
- **32 инструментов MCP** — полное покрытие Gerrit REST API: поиск изменений,
...
- [Использование](docs/ru/usage.md) — справочник по конфигурации, режимы транспорта, все 32 инструментов MCP
